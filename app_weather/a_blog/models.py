...
class Comments(models.Model):
    ...
    post = models.ForeignKey(Blog, verbose_name='коментарии', on_delete=models.CASCADE, related_name="comments")
    ...
    def __str__(self):
        return f'{self.name}, {self.post}, {self.text_comments},{self.created}'
